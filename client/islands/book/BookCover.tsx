...
type Props = Readonly | PickImage;

export default function BookCover(props: Props) {
  return (
    <>
      <div class='w-full h-full bg-gray-600 flex justify-center items-center relative'>
        {props.readonly ? (
          <>
            {props.cover ? (
              <img
          ...
          <>
            ...
            <div class='absolute right-0 bottom-0 m-4 z-10'>
              <CoverUpload cover={props.cover} />
            </div>
          </>
        )}
      </div>
